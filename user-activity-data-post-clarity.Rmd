...
updated_workstn_owner_query <- glue("CREATE TABLE PROD_ROOM_UTILIZATION_TABLE AS
                               ...
                               b.WORKSTN_OWNER
                               FROM
                              (SELECT * FROM ROOM_UTILIZATION_MERGED) a
                               LEFT JOIN 
                              (SELECT WORKSTN_IDENTIFIER, WORKSTN_OWNER, START_DATE, END_DATE FROM PROD_WORKSTATION_MAPPING) b
                               ON a.WORKSTN_IDENTIFIER = b.WORKSTN_IDENTIFIER
                               AND EXTRACT(MONTH FROM a.ACTIVITY_DATE) >= EXTRACT(MONTH FROM b.ASSIGN_START_DATE)
                               AND EXTRACT(YEAR FROM a.ACTIVITY_DATE) >= EXTRACT(YEAR FROM b.ASSIGN_START_DATE)
                               AND EXTRACT(MONTH FROM a.ACTIVITY_DATE) <= EXTRACT(MONTH FROM b.ASSIGN_END_DATE)
                               AND EXTRACT(YEAR FROM a.ACTIVITY_DATE) <= EXTRACT(YEAR FROM b.ASSIGN_END_DATE);
                              ")

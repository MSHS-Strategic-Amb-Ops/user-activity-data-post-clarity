...
### Once we have assign start and end date in the data, run this query and replace USER_ACTIVITY_HOUR_TABLE to PROD_USER_ACTIVITY_HOUR_TABLE from next chunk onwards wherever needed. No other change required.
